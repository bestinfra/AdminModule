...
export default function AssetManagment() {
    ...
    const [useDummyData, _setUseDummyData] = useState(true); // Toggle to use dummy data
    ...
    // Get the data to display - either dummy data or API data
                                    ...
                                    columns: [
                                        {
                                            ...
                                            props: {
                                                data: {
                                                    Location: mapHierarchyForNodeChart(dummyHierarchyData)
                                                },
                                                width: '100%',
                                                height: '100%',
                                                enableZoom: true,
