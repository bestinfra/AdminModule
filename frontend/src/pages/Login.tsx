...
const INPUT_ERROR_CLASSES = "ring-2 ring-danger bg-danger-light border-danger";
    ...
    <div className="min-h-screen bg-primary-lightest flex items-center justify-center px-4">
      <div className="w-full max-w-md">
          ...
          {Object.entries(errors).map(([field, message]) => 
            message && (
              <div key={field} className="bg-danger-light border border-danger rounded-lg p-3 mb-2">
                <div className="flex items-center">
                  ...
                  <div className="ml-auto pl-3 flex items-center">
                    <button type="button" onClick={() => clearError(field)} className="inline-flex items-center justify-center text-danger hover:text-danger-alt transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="relative">
              <input
                ...
                required
              />
              <div className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1 text-neutral">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center select-none cursor-pointer">
                ...
                />
                <span className="w-6 h-6 rounded-lg border-2 border-neutral-light bg-transparent flex items-center justify-center mr-2 transition peer-checked:bg-primary peer-checked:border-primary">
                  {formData.rememberMe && (
              ...
              <button type="button" onClick={handleForgotPassword} className="text-base text-primary hover:text-primary-dark font-medium">
                Forgot Password?
              </button>
            </div>
            ...
            <div className="pt-2 flex justify-center">
              <button
                ...
                className="w-50 bg-secondary hover:bg-secondary-light text-white py-3 px-4 rounded-full font-semibold focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm"
              >
