...
const SubLogin = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-primary-lightest dark:bg-primary-dark">
      <form onSubmit={handleSubmit} className="bg-white dark:bg-primary-dark-light p-8 rounded shadow-md w-96">
        ...
        <input
          type="email"
          placeholder="Email"
          className="w-full mb-4 p-2 border rounded dark:bg-primary-dark-light dark:text-white"
          value={email}
        ...
        <input
          ...
          className="w-full mb-6 p-2 border rounded dark:bg-primary-dark-light dark:text-white"
          value={password}
