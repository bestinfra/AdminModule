...
const AccessControl: React.FC<AccessControlProps> = ({
    ...
    const handleNewAccountChange = (
        ...
        const updatedAccounts =
            formData.newAccounts?.map((account) =>
                ...
                <div className="col-span-1 lg:col-span-3 p-4 flex flex-col gap-4">
                    <div className="">
                        ...
                        <p className="text-base text-gray-600 mt-2">
                            Set up the primary administrator account for your
                            application
                        </p>
                    </div>
                    ...
                    <form
                        ...
                        <div className="p-4 border border-primary-border rounded-xl">
                            <div className="mb-4 flex items-start gap-4">
                                ...
                                <div className="text-xs  px-4 py-1 rounded-full bg-primary-lightest">
                                    Default
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
                                ...
                                <div>
                                    <FormInput
                                        ...
                                        showError={
                                            !!allErrors.adminConfirmPassword
                                        }
                                        disabled={loading}
                                        onInputChange={handleFormInputChange}
                                        onInputBlur={handleFormInputBlur}
                        ...
                        {formData.newAccounts?.map((account, index) => (
                            <div
                                key={account.id}
                                className="p-4 border border-primary-border rounded-xl">
                                <div className="mb-4 flex items-start gap-4 justify-between">
                                    <div className="h-full flex items-start gap-4">
                                        <h3 className="text-sm font-semibold text-primary">
                                            New Account {index + 1}
                                        </h3>
                                        <div className="text-xs bg-secondary-light px-4 py-1 rounded-full">
                                            Optional
                                        </div>
                                    </div>
                            ...
                            <div className="mb-4 flex items-start gap-4 justify-between">
                                ...
                                <button
                                    ...
                                    <span
                                        ...
                                        style={{
                                            filter: 'invert(17%) sepia(80%) saturate(749%) hue-rotate(180deg) brightness(90%) contrast(92%)',
                                        }}>
                                        <img
                                            src="/icons/plus2.svg"
                                            alt="add account"
              ...
              />
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <label
                                ...
                                className="text-sm font-medium text-main dark:text-white select-none">
