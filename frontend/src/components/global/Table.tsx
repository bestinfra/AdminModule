        ...
        <div className="flex items-center gap-4">
          ...
          {onPayment && (
            <span
              ...
              title="Payment"
            >
              <img src="/icons/payment.svg" alt="Payment" className="w-4 h-4" />
            </span>
          )}
          {onEdit && (
            <span
              ...
              title="Edit"
            >
              <img src="/icons/user-pen.svg" alt="Edit" className="w-4 h-4" />
            </span>
          )}
          {onDelete && (
            <span
  ...
  const handleSelectAll = (isSelected: boolean) => {
    ...
    const newSelectedRows = isSelected
      ? paginatedData.map((row) =>
          String(row.id || row.meterNo || row.unitId || row.ticketNumber || "")
        )
      : [];
        ...
        <div className="border border-primary-border dark:border-dark-border rounded-2xl overflow-hidden">
          ...
          >
            <thead className="dark:bg-primary-dark-light bg-background-secondary overflow-hidden">
              <tr className="font-manrope text-base font-normal w-full dark:text-white border-b border-primary-border dark:border-dark-border">
                {selectable && (
                  <th
                    scope="col"
                      ...
                      <tr
                        ...
                        className={`${
                          index < paginatedData.length - 1
                            ? "border-b border-primary-border dark:border-dark-border"
                            : ""
                        } ${
              ...
              <div className="flex items-center gap-5">
                ...
                {showCustomInput && (
                  <input
                    ...
                    onKeyDown={handleCustomRowsPerPageSubmit}
