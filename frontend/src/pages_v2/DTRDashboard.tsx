...
const DTRDashboard: React.FC = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const consumptionResponse = await fetch(
                    `${BACKEND_URL}/dtrs/consumptionStats`
                );
    ...
    const seriesData = statusTypes.map((type) => ({
        ...
        data: trends.map((t) => {
            switch (type.key) {
                case 'detected_count':
                    return t.detected_count;
                case 'analyzing_count':
                    return t.analyzing_count;
                case 'repairing_count':
                    return t.repairing_count;
                case 'resolved_count':
                    return t.resolved_count;
                case 'unresolved_count':
                    return t.unresolved_count;
                default:
                    return 0;
            }
        }),
                            ...
                            components: [
                                ...
                                },
                                {
                                    ...
                                    props: {
                                        ...
                                        subtitle1: `${
                                            dtrStats.fuseBlownPercentage || 0
                                        }% of Total DTRs`,
                                        onValueClick: () =>
                                            navigate(
                                ...
                                },
                                {
                                    ...
                                    props: {
                                        ...
                                        icon: '/icons/dtr.svg',
                                        subtitle1: `${
                                            dtrStats.overloadedPercentage || 0
                                        }% of Total Feeders`,
                                        onValueClick: () =>
                                            navigate(
                                ...
                                },
                                {
                                    ...
                                    props: {
                                        ...
                                        icon: '/icons/dtr.svg',
                                        subtitle1: `${
                                            dtrStats.underloadedPercentage || 0
                                        }% of Total Feeders`,
                                        onValueClick: () =>
                                            navigate(
                                ...
                                },
                                {
                                    ...
                                    props: {
                                        ...
                                        icon: '/icons/dtr.svg',
                                        subtitle1: `${
                                            dtrStats.unbalancedPercentage || 0
                                        }% of Total DTRs`,
                                        onValueClick: () =>
                                            navigate(
                                ...
                                },
                                {
                                    ...
                                    props: {
                                        ...
                                        value:
                                            dtrStats.powerFailureFeeders || 0,
                                        icon: '/icons/power_failure.svg',
                                        subtitle1: `${
                                            dtrStats.powerFailurePercentage || 0
                                        }% of Feeders`,
                                        onValueClick: () =>
                                            navigate(
                            ...
                            components: [
                                ...
                                },
                                {
                                    ...
                                    props: {
                                        ...
                                        showTableView: true,
                                        ariaLabel:
                                            'Monthly DTR alert statistics chart',
                                    },
                                },
                            ],
                        },
