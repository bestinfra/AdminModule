...
const stats = [
    ...
    },
    {
        ...
        value: '255.089',
        icon: '/icons/y-phase-voltage.svg',
        subtitle1: 'Volts',
    },
    {
        title: 'B-Phase Voltage',
        value: '254.417',
        icon: '/icons/b-phase-voltage.svg',
        subtitle1: 'Volts',
    },
    {
    ...
    },
    {
        ...
        value: '27.644',
        icon: '/icons/y-phase-current.svg',
        subtitle1: 'Amps',
    },
    {
        title: 'B-Phase Current',
        value: '33.984',
        icon: '/icons/b-phase-current.svg',
        subtitle1: 'Amps',
    },
    {
...
const Feeders = () => {
    ...
    const actionsComponent = createActionsComponent([
        {
            label: 'Download Data',
            onClick: () => console.log('Downloading feeder data...'),
            variant: 'outline',
        },
        {
            label: 'Export Report',
                ...
                <div className="bg-white border border-primary-border rounded-2xl p-0">
                    <div className="flex justify-between items-center mb-2 bg-primary-lightest rounded-lg px-4 py-4">
                        <span className="text-base font-medium text-main">
                            Daily Consumption Metrics (06 May, 2025 - 06 Jul,
                            2025)
                        </span>
                            ...
                            seriesData={[
                                {
                                    ...
                                    data: [
                                        ...
                                        572, 572, 572, 572, 572, 572, 610, 572,
                                        572, 572, 572, 572, 572, 572, 572, 572,
                                        572, 572, 572, 572, 572, 572, 572, 572,
                                        572, 572, 572, 572, 572, 572, 572, 572,
                                        572, 572, 572, 572, 572, 572, 572, 572,
                            ...
                            seriesData={[
                                {
                                    name: 'Consumption',
                                    data: [
                                        0, 0, 0, 0, 0, 0, 0, 6000, 14000, 18000,
                                        17000, 16000, 0,
                                    ],
                                },
                            ]}
