...
<<<<<<< HEAD:src/components/Occupancy-Vacency/OccupancyStatus.tsx
              gap: "gap-1",
=======
              gap: "gap-0",
>>>>>>> be6a00465516c0f621bf0dfd1b2252475400ac8d:frontend/src/components/Occupancy-Vacency/OccupancyStatus.tsx
              rows: [
                {
                  layout: "row",
                  columns: [
